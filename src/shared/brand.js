...
export const BRAND_LOGO_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="128" height="128">
  <defs>
...
export const BRAND_LOGO_DATA_URI = `data:image/svg+xml,${encodeURIComponent(BRAND_LOGO_SVG)}`;
